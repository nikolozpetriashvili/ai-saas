...
const ImagePage = () => {
  ...
  return(
    <div>
      <Heading title={'Image'} description={'Turn your prompt into an image'} icon={ImageIcon} iconColor={'text-pink-700'} bgColor={'bg-pink-700/10'} />
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className='rounded-lg border w-full p-4 px-3 md:px-6 focus-within:shadow-sm grid grid-cols-12 gap-2'>
              <FormField name='prompt' render={({field})=> (<FormItem className='col-span-12 lg:col-span-6'>
                <FormControl className='m-0 p-0'>
                  <Input className='border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent' disabled={isLoading} placeholder='What does Santa Claus look like?'
                  {...field} 
                  />
                </FormControl>
              </FormItem>)} />
